...
declare type HeadingTypes = 'page-h' | 'article-h' | 'article-h-longread' | 'article-h-longread-persoonlijk' | 'breaking-teaser-h' | 'opening-teaser-h' | 'teaser-h' | 'search-teaser-h' | 'cover-teaser-h' | 'square-teaser-h' | 'service-h' | 'service-accordion-h' | 'my-news-aside-h' | 'article-h-inline-number-frame' | 'article-h-longread-inline-number-frame' | 'article-h-persoonlijk-inline-number-frame' | 'article-h-subheader' | 'article-h-longread-subheader' | 'article-h-subheader2' | 'article-h-longread-subheader2' | 'article-h-inline' | 'article-h-longread-inline' | 'article-h-persoonlijk-inline' | 'article-h-inline-stack-frame' | 'article-h-inline-link-block' | 'card-h' | 'card-h-longread' | 'card-h-persoonlijk';
